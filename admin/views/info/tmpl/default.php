			...
			<div class="row-fluid form-horizontal-desktop">
				<div class="span8">
					<fieldset>
    					...
    					<div class="icons">
                    		...
                    		<?php echo $this->getIcon('index.php?option=com_payperdownload&amp;view=licenses', 'icon-grid', JText::_ ('COM_PAYPERDOWNLOAD_LICENSES')); ?>
    						...
    						<table class="table table-striped" cellpading="0" cellspacing="0">
    							<tbody>
									<?php foreach ($this->extended_plugins as $extra_plugin) : ?>
										<?php JFactory::getLanguage()->load('plg_payperdownloadplus_' . $extra_plugin->name . '.sys', JPATH_ADMINISTRATOR); ?>
        								<tr>
        									<?php if (in_array($extra_plugin->name, array('content', 'jdownload', 'k2', 'kunena', 'menuitem', 'phocadownload'))) : ?>
        										<td><?php echo JText::_('COM_PAYPERDOWNLOAD_PLUGIN_'.strtoupper($extra_plugin->name)); ?></td>
        									<?php else : ?>
        										<td><?php echo JText::_('PLG_PAYPERDOWNLOADPLUS_' . strtoupper($extra_plugin->name)); ?></td>
        									<?php endif; ?>
        									<?php if (JPluginHelper::isEnabled('payperdownloadplus', $extra_plugin->name)) : ?>
				...
				<div class="span4">
					<fieldset>
						...
						<p style="text-align: center;"><img src="<?php echo JURI::root(true) ?>/administrator/components/com_payperdownload/images/ppdplus.png" /></p>
						<table class="table table-striped" cellpading="0" cellspacing="0">
							<tbody>
								<tr>
								...
								<?php if ($this->version_array && $this->version_array['relevance'] && version_compare($this->extension_version, $this->version_array['latest'], 'lt')) : ?>
    								<tr class="warning">
    									<td><?php echo JText::_('COM_PAYPERDOWNLOAD_INFO_LATESTVERSIONNOTABLE'); ?></td>
    									<td><span class="label label-warning"><?php echo $this->version_array['latest']; ?></span>&nbsp;<?php echo $this->version_array['relevance']; ?></td>
    								</tr>
    							<?php endif; ?>
								<tr>
								...
								<tr>
									...
									<td>Ratmil Torres,<br />Olivier Buisard (v6 revisions) </td>
								</tr>
							</tbody>
						</table>
					</fieldset>
...
<div class="span12 copyright-container">
	<p><?php echo JText::_('COM_PAYPERDOWNLOAD'); ?> <?php echo JText::sprintf('COM_PAYPERDOWNLOAD_INFO_VERSIONNUMBER', $this->extension_version); ?></p>
