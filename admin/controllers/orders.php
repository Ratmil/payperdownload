...
class OrdersForm extends PPDForm
{
	...
	*/
	function __construct()
	{
		...
		$this->formTitle = JText::_('PAYPERDOWNLOADPLUS_PAYMENTS_99');
		$this->toolbarTitle = JText::_('COM_PAYPERDOWNLOAD_PAYMENTS_TITLE');
	...
	*/
	...
	function createToolbar($task, $option)
	{
		...
		JToolBarHelper::title( $this->toolbarTitle, 'credit-2' );
		switch($task)
		{
			case 'edit':
			case 'add':
			...
			case 'statistics':
				...
				break;
			default:
				JToolBarHelper::custom('statistics', 'bars', '', JText::_('PAYPERDOWNLOADPLUS_STATISTICS_115'), false);
				JToolBarHelper::custom('edit', 'eye-open', '', JText::_('PAYPERDOWNLOADPLUS_VIEW_116'));
				JToolBarHelper::deleteList();
				JToolBarHelper::custom('del', 'delete', '', JText::_('PAYPERDOWNLOADPLUS_DELETE_OLD'), false);
			break;
		}
	}
